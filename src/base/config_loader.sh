...
load_config "store_serialized_dags" "${CORE_STORE_SERIALIZED_DAGS:=False}" "airflow.cfg"
...
load_config "force_log_out_after" "${WEBSERVER_FORCE_LOG_OUT_AFTER:=0}" "airflow.cfg"
load_config "session_lifetime_days" "${WEBSERVER_SESSION_LIFETIME_DAYS:=30}" "airflow.cfg"
...
load_config "operation_timeout" "${CELERY_OPERATION_TIMEOUT:=2}" "airflow.cfg"
...
load_config "failover_timeout" "${MESOS_FAILOVER_TIMEOUT:=NULL}" "airflow.cfg"
load_config "default_principal" "${MESOS_DEFAULT_PRINCIPAL:=NULL}" "airflow.cfg"
load_config "default_secret" "${MESOS_DEFAULT_SECRET:=NULL}" "airflow.cfg"
load_config "docker_image_slave" "${MESOS_DOCKER_IMAGE_SLAVE:=NULL}" "airflow.cfg"
