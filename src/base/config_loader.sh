...
load_config_with_opt "sql_alchemy_conn" "${AIRFLOW_DATABASE_PASSWORD}" "${AIRFLOW_DATABASE_TYPE}://${AIRFLOW_DATABASE_USER}:${AIRFLOW_DATABASE_PASSWORD}@${AIRFLOW_DATABASE_HOST}:${AIRFLOW_DATABASE_PORT}/airflow" "${AIRFLOW_DATABASE_TYPE}://${AIRFLOW_DATABASE_HOST}:${AIRFLOW_DATABASE_PORT}/airflow" "airflow.cfg"
...
load_config_with_opt "broker_url" "${AIRFLOW_BROKER_PASSWORD}" "${AIRFLOW_BROKER_TYPE}://${AIRFLOW_BROKER_USER}:${AIRFLOW_BROKER_PASSWORD}@${AIRFLOW_BROKER_HOST}:${AIRFLOW_BROKER_PORT}/0" "${AIRFLOW_BROKER_TYPE}://${AIRFLOW_BROKER_HOST}:${AIRFLOW_BROKER_PORT}/0" "airflow.cfg"
load_config_with_opt "result_backend" "${AIRFLOW_BROKER_RESULT_BACKEND_PASSWORD}" "db+${AIRFLOW_BROKER_RESULT_BACKEND_TYPE}://${AIRFLOW_BROKER_RESULT_BACKEND_USER}:${AIRFLOW_BROKER_RESULT_BACKEND_PASSWORD}@${AIRFLOW_BROKER_RESULT_BACKEND_HOST}:${AIRFLOW_BROKER_RESULT_BACKEND_PORT}/airflow" "db+${AIRFLOW_BROKER_RESULT_BACKEND_TYPE}://${AIRFLOW_BROKER_RESULT_BACKEND_HOST}:${AIRFLOW_BROKER_RESULT_BACKEND_PORT}/airflow" "airflow.cfg"
