...
load_config_with_opt "sql_alchemy_conn" "${AIRFLOW_DATABASE_PASSWORD}" "${AIRFLOW_DATABASE_TYPE}://${AIRFLOW_DATABASE_USERNAME}:${AIRFLOW_DATABASE_PASSWORD}@${AIRFLOW_DATABASE_HOST}:${AIRFLOW_DATABASE_PORT}/airflow" "${AIRFLOW_DATABASE_TYPE}://${AIRFLOW_DATABASE_HOST}:${AIRFLOW_DATABASE_PORT}/airflow" "airflow.cfg"
