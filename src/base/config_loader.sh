...
load_config "dags_folder" "${CORE_DAGS_FOLDER}" "airflow.cfg"
load_config "dags_are_paused_at_creation" "${CORE_DAGS_ARE_PAUSED_AT_CREATION}" "airflow.cfg"
load_config "base_log_folder" "${CORE_BASE_LOG_FOLDER}" "airflow.cfg"
...
load_config "dag_processor_manager_log_location" "${CORE_DAG_PROCESSOR_MANAGER_LOG_LOCATION}" "airflow.cfg"
...
load_config "plugins_folder" "${CORE_PLUGINS_FOLDER}" "airflow.cfg"
...
load_config "child_process_log_directory" "${SCHEDULER_CHILD_PROCESS_LOG_DIRECTORY}" "airflow.cfg"
